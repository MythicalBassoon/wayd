...
function htmlGenerator(title, bigPicture, description, address, city, state, link, time){
console.log('in vote template, params are:', title, bigPicture, description, address, city, state, link, time)
...
'           '+
'           <h3 style="margin: 0;padding: 0;font-family: &quot;HelveticaNeue-Light&quot;, &quot;Helvetica Neue Light&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, &quot;Lucida Grande&quot;, sans-serif;line-height: 1.1;margin-bottom: 15px;color: #000;font-weight: 500;font-size: 27px;">Thanks for voting! We\'ll send you a followup email when all your other friends have voted too!</h3>'+
'           '+
